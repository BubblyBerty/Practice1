...
print("Elements common to both lists:",listCD)

eList = ["a", "b", "c"]
fList = ["c", "d", "e"]
listEF = [eList[i] for i in range(len(eList)) if eList[i] in fList]
print("Elements common to both lists:",listEF)

"Objective"
"" '' # Compare list comprehension with non list comprehension syntax 

"This is not list comprehension (a sort of filtering) - methods used before line 37"
...
"Objective"
"" '' # Use List comprehension to create one list out of another list
"This is List comprehension - methods used between lines 37 and 56"
