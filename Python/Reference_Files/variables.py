...
""" A variable .........Unlike other programming languages, Python has no command for declaring a variable. Variables do not need to be declared with any particular type and can even change type after they have been set."""
...
print(type(num1)) # a number/integer
...
name, address, interest = "Bob", "Somewhere", "I am"
print(name, address, interest)


"Chained assignment"
first_child = second_child = third_child = ": Bob"
print(
...
num4 = "10"
print(id(num1))
print(id(num4)) # They cannot be; num1 is an integer, num4 is a string
...
#The equivalent of data type


"Knowledge Check"
#To DO: Write one thing you remember from what we covered so far?
""" In Python varibles do not need to be declared. They can change their data type dynamically. Values can be assigned in chains."""

"Read, Run and investigate the lines of code below"

# Variable naming convention
username = "user1 = bubblyberty"  # meaningful name

# use of camel notation when the variable is a combination of two words
userName = "user2 = bubblyBerty"

 # use snake case/underscore when the variable is a combination of two words
user_name = "user3 = Bubbly_Berty" 

user4 = "Bubbly0001"  # meaningful name_

print(username,"\n",userName,"\n",user_name," ",user4,"\n")

userAge = 64  # meaningful name
print(userAge)
...
# £cash = 1.00
# $cash = 1.00 - this is acceptable in JS but neither is in Python
...
# Cannot find quickly but I cannot see any difference