...
filePath1 = open('Python/Pt7_FilesDictsCodeBase2024/file1.txt', 'w') # folder/folder/filename
# write to file
...
filePath1 = open('Python/Pt7_FilesDictsCodeBase2024/robert.txt', 'w') # folder/folder/filename
filePath1.write("My name is Robert Morris")
