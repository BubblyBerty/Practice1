...
FROM Employee e LEFT JOIN Employee m ON m.SSN=e.SUPERSSN; -- Make this work
...
select dayname('1959-07-06');
SELECT concat(DATE_FORMAT(CURdate(), "%d")," of ",DATE_FORMAT(CURdate(), "%M")," ",DATE_FORMAT(CURdate(), "%Y")) as "Today";
